...
<body>
	...
	<div class="main main--profile" style="">
		...
		<div class="mod_tab" role="nav">
			<a class="mod_tab__item" href="javascript:;" data-tab="like_song" data-stat="y_new.profile.like.tab.song">歌曲 36</a>
			<a class="mod_tab__item mod_tab__current" href="javascript:;" data-tab="like_playlist" data-stat="y_new.profile.like.tab.playlist">歌单 1</a>
		...
		<div class="style_switch" aria-label="排列方式">
			<a href="javascript:;" class="style_switch__item style_switch__item--select" title="上图下文" data-type="mod_playlist" data-tab="like_playlist" data-stat="y_new.profile.like.playlist.pic_mod"><img src="image/表格active.png" alt="play" height="17px" width="17px" class="style_switch__item_img"/></a>
			<a href="javascript:;" class="style_switch__item_right " title="列表" data-type="mod_playlist_text" data-tab="like_playlist" data-stat="y_new.profile.like.playlist.list_mod"><img src="image/列表.png" alt="play" height="17px" width="17px" class="style_switch__item_img"/></a>
		    </div>
	...
	<!--disk导航-->
	<nav class="top-right">
	<a class="disc l1" onMouseOver="disc1_over()" onMouseOut="disc1_out()">
	<div id="disc1" class="">个人主页</div>
	</a>
	<a class="disc l2" onMouseOver="disc2_over()" onMouseOut="disc2_out()">
	<div id="disc2" class="">我的音乐</div>
	</a>
	<a class="disc l3" onMouseOver="disc3_over()" onMouseOut="disc3_out()">
	<div id="disc3" class="">我的好友</div>
	</a>
	<a class="disc l4" onMouseOver="disc4_over()" onMouseOut="disc4_out()">

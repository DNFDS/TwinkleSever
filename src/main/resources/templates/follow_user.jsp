...
<body>
	...
	<div class="main main--profile" style="">
		...
		<div class="mod_tab" role="nav">
			<a class="mod_tab__item" href="follow_singer.jsp" data-tab="like_playlist" data-stat="y_new.profile.like.tab.playlist">歌手</a>
			<span class="mod_tab__item mod_tab__current">用户</span>
		</div>

...
<body>
	...
	<div class="main main--profile"  style="">
		...
		<div class="style_switch" aria-label="排列方式">
			<a href="like_songlist_form.jsp" class="style_switch__item" title="上图下文" data-type="mod_playlist" data-tab="like_playlist" data-stat="y_new.profile.like.playlist.pic_mod"><img src="image/Index_image/表格.png" alt="play" height="17px" width="17px" class="style_switch__item_img"/></a>
